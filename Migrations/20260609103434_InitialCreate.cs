        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Reservations_AspNetUsers_ApprovedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RegistrationToken = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Attendees", x => x.AttendeeId);
                    table.ForeignKey(
                        name: "FK_Attendees_Reservations_ReservationId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendees_RegistrationToken",
                table: "Attendees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendees_ReservationId",
                table: "Attendees",
